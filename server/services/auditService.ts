...
export enum AuditPage {
  PRISONER_FINANCE_HOME = 'PRISONER_FINANCE_HOME_PAGE',
  FIND_PRISONER = 'FIND_PRISONER_PAGE',
  PRISONER_FINANCIAL_PROFILE = 'PRISONER_FINANCIAL_PROFILE_PAGE',
  ...
  // Holds
  PRISONER_HOLDS = 'PRISONER_HOLDS_PAGE',

  // Advances
  PRISONER_ADVANCES = 'PRISONER_ADVANCES_PAGE',
  PRISONER_ADVANCE_DETAIL = 'PRISONER_ADVANCE_DETAIL_PAGE',
